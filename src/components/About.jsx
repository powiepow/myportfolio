    ...
    <div className="container">
      <div className="about-grid">
        <div className="about-text">
          ...
          <a
            href="https://acrobat.adobe.com/id/urn:aaid:sc:AP:51ae3435-a060-4182-9998-9fd0234e2295"
            target="_blank"
            rel="noopener noreferrer"
            className="btn"
          >
            <i className="fa-solid fa-up-right-from-square"></i> View CV
          </a>
        </div>
        <div>
          <ul className="skills-list">
            ...
            <li><i className="fas fa-wind"></i> Tailwind</li>
